                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ellerium") + " - ";
#ifdef ENABLE_WALLET
    ...
    labelELPIcon = new QLabel();
    //labelELPIcon->setObjectName("XmxIcon");
    //labelELPIcon->setStyleSheet("QLabel {font-family: Segoe UI, Tahoe, Georgia, sans-serif, font-weight: 900; font-size: 14px; color: #606060; }");
    labelELPIcon->setPixmap(QIcon(":/icons/label_ellerium").pixmap(37, 11));
    frameBlocksLayout->addStretch();
    frameBlocksLayout->addWidget(labelELPIcon);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ELP:URIs)"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About Ellerium Core"), this);
    ...
    openAction->setStatusTip(tr("Open a ELP:URI or payment request"));
...
{
    QString strTitle = tr("Ellerium"); // default title
