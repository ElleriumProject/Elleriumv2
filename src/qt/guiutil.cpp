...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Ellerium address (e.g. %1)").arg("XLd5zb7KJewkBNH7xb94r9WHUVrxKiXLcS"));
#endif
...
{
    // return if URI is not valid or is no ELP:URI
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient* out)
{
    // Convert ELP:// to ELP:
    //
    //    Cannot handle this later, because ELP:// will cause Qt to see the part after // as host,
