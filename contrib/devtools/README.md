...
elleriumcoin/ellerium-core repository.
...
Configuring the github-merge tool for the Ellerium repository is done in the following way:
    ...
    git config githubmerge.repository elleriumcoin/ellerium-core
...
A script to optimize png files in the Ellerium repository (requires pngcrush).
